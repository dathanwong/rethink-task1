# Notes
Implemented text editors for all of the files and a save button as well as a markdown previewer. Using the react-markdown library to preview markdown https://www.npmjs.com/package/react-markdown.
